...
from data.mm_data.sunrefer_dataset import SunreferDataset
from fairseq import metrics
from fairseq.tasks import register_task
from tasks.mm_tasks.refcoco import RefcocoConfig
...
@dataclass
class SunreferConfig(RefcocoConfig):
    pass


@register_task("sunrefer", dataclass=SunreferConfig)
class SunreferTask(OFATask):
    def __init__(self, cfg: SunreferConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = SunreferDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
